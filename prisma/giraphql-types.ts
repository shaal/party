import type { Prisma, User, Session, Profile, Post, PostTopics, Topic, Like, Product, Notification } from "@prisma/client";
export default interface PrismaTypes {
    User: {
        Shape: User;
        Include: Prisma.UserInclude;
        Where: Prisma.UserWhereUniqueInput;
        Fields: "posts" | "products" | "sessions" | "profile" | "following" | "followedBy" | "likes" | "myNotification" | "sentNotification";
        ListRelations: "posts" | "products" | "sessions" | "following" | "followedBy" | "likes" | "myNotification" | "sentNotification";
        Relations: {
            posts: {
                Shape: Post[];
